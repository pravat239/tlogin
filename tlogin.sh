...
line
echo ""
printf "${red}YouTube ${blue}https://youtube.com/channel/UCjLdjjy-2AzRD6gYAuex8uw${reset}\n"
printf "${red}Instgram ${blue}https://instagram.com/coding_by_pravat?utm_medium=copy_link${reset}\n"
line
echo ""
line
